 ...
 *
 * Uses the `setup()` option because {@see useTokenSegments}/{@see useTokenPicker}
 * and the document-level dismissal below register lifecycle hooks that
...
export default {
    ...
    components: { 'v-token-chip': TokenChip, 'v-token-picker-menu': TokenPickerMenu },
};
</script>
