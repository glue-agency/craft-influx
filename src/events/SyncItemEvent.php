 ...
 * `element` freely), and EVENT_AFTER_ITEM (`element` committed; `action` is the
 * outcome: created/updated/unchanged/error). A skipped item returns before the
 * after-event fires, and the missing-elements sweep's outcomes (disabled,
 * deleted, ...) are log rows only, never event payloads.
 *
 *   Event::on(
